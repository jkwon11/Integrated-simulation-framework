...
#temp
#binary_dir = spec_dir
data_dir = "/home/SJ/sPEC_CPU_V1.1/spec_cpu2006/benchspec/CPU2006/"
 
#400.perlbench
perlbench = Process() # Update June 7, 2017: This used to be LiveProcess()
perlbench.executable =  '400.perlbench' + alpha_suffix
# TEST CMDS
...
bwaves.executable = '410.bwaves' + alpha_suffix
# TEST CMDS
...
#data = '/home/SJ/sPEC_CPU_V1.1/spec_cpu2006/benchspec/CPU2006/453.povray/data/test/input/SPEC-benchmark-test.ini'
#data = '../453.povray/data/test/input/SPEC-benchmark-test.ini'
...
calculix.executable = '454.calculix' + alpha_suffix
# TEST CMDS
